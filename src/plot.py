...
def main():
    ...
    for monthname in monthname_all:   
        ...
        # prepare
        prequatt, data, data_resampled, aggrgate_during_day_10mins, aggrgate_during_day_hourly = utility.prepare(prequatt, data, data_during_day, data_electricity_usage_year, data_electricity_usage_heatingseason)
        ...
        df_result['Gas_Usage_Per_Year_Per_House_AfterQuatt'] = data['gas_usage']
        df_result['Gas_Usage_Per_Year_Per_House_PreQuatt'] = prequatt['NATURAL_GAS']
        df_result['Gas_Usage_Per_Year_Per_M2_AfterQuatt'] = data['gas_usage_perM2']
        df_result['Gas_Usage_Per_Year_Per_M2_PreQuatt'] = prequatt['NATURAL_GAS_perM2']
        df_result['CO2_Emission_Per_Year_Per_House_AfterQuatt']    = data['co2_emission']
        df_result['CO2_Emission_Per_Year_Per_House_PreQuatt']    = prequatt['co2_emission_updated']
        df_result['CO2_Emission_Per_Year_Per_M2_AfterQuatt']    = data['co2_emission_perM2']
        ...
        #plot_functions.SankeyDiagram(data)
